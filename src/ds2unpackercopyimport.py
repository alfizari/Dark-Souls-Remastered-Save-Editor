    ...
    def decrypt(self) -> None:
        ...
        try:
            ...
            if self._decrypted_slot_path is not None and self._decrypted_data:
                ...
                self._decrypted_slot_path = os.path.join(script_dir, "imported")
...
def decrypt_ds2_sl2_import(input_file, log_callback=None) -> Dict[int, str]:
    ...
    script_dir = os.path.dirname(os.path.abspath(__file__))
    output_folder = os.path.join(script_dir, "imported")
    ...
    return os.path.join(os.path.dirname(os.path.abspath(__file__)), "imported")
